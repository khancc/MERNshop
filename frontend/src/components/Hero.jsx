  ...
  return (
    <section className='max-padd-container bg-hero bg-cover bg-center bg-no-repeat h-[744px] w-full' id='home'>
        <div className='relative top-24 xs:top-72'>
          ...
          <h1 className='h1 capitalize max-w-[40rem]'>Upgrade Your Fashion <span className='text-secondary'>with Every Click.</span> Shop Today!</h1>
          <p className='my-5 max-w-[33rem]'>Id officia est nisi enim est. Adipisicing consectetur Lorem qui dolore ea labore. Laborum cupidatat irure reprehenderit pariatur reprehenderit commodo dolor culpa aute tempor.</p>
